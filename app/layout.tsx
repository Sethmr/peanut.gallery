          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              featureList: [
                ...
                "AI fact-checking with Brave Search or xAI Live Search",
                "4 AI personas react to any YouTube video",
                "Illustrated peanut mascots for every persona",
                ...
                "Free 15-minute trial of the hosted backend",
                "Bring your own API keys — free forever",
                "Peanut Gallery Plus: $8/month for 16 hours/week on the hosted backend",
