...
| **Peanut Gallery Plus subscription** | [`SUBSCRIPTION-ARCHITECTURE.md`](SUBSCRIPTION-ARCHITECTURE.md) — canonical architecture (modes, identity, endpoints, phases, economics). [`STRIPE-INTEGRATION.md`](STRIPE-INTEGRATION.md) — operator step-by-step for Seth's Stripe dashboard work (SET-28). [`legal/TERMS-OF-SERVICE.md`](legal/TERMS-OF-SERVICE.md) + [`legal/PRIVACY-POLICY.md`](legal/PRIVACY-POLICY.md) — drafts pending lawyer review. v1.9.x. |
